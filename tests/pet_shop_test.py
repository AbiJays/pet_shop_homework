...
# 3.
    def test_add_or_remove_cash__add(self): # double underscores 
                # means its a different outcome of same test so remove is working in the same function.
